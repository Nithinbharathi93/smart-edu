  ...
  const handleSend = async (e) => {
    ...
    try {
      ...
      setMessages(prev => [...prev, {
        id: Date.now() + 1,
        role: 'ai',
        content: "Oops! Something went wrong. Make sure you've uploaded a PDF and try rephrasing your question. I'm here to help! 💪",
        isError: true,
        sourceExpanded: false
      }]);
    } finally {
      ...
      <main className="flex-grow flex flex-col h-[calc(100vh-128px)]" style={{ width: '98vw' }}>
        ...
        <div className="bg-white p-4 border-b border-gray-200 shadow-sm flex items-center justify-between">
            <div className="flex items-center gap-3">
                ...
                <div>
                    <h2 className="font-bold text-gray-900">Study Companion</h2>
        ...
        <div className="flex-grow bg-white overflow-y-auto p-6 space-y-6">
            {messages.map((msg) => (
                ...
                >
                    ...
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 ${
                        msg.role === 'user' ? 'bg-gray-900 text-white' : 'bg-green-100 text-green-700'
                    }`}>
                        ...
                        {msg.source && msg.role === 'ai' && (
                            <div className="mt-3 w-full max-w-md">
                                <button
                                    ...
                                    className="flex items-center gap-2 text-xs font-semibold text-yellow-700 bg-yellow-50 hover:bg-yellow-100 px-3 py-2 rounded-lg border border-yellow-200 transition w-full justify-between"
                                >
                                ...
                                {msg.sourceExpanded && (
                                    <div className="mt-2 bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-xs leading-relaxed text-yellow-800">
            ...
            {loading && (
                <div className="flex gap-4">
                    ...
                    <div className="bg-gray-50 px-5 py-4 rounded-2xl rounded-tl-none border border-gray-100 flex items-center gap-2">
        ...
        <div className="bg-white p-4 border-t border-gray-200 shadow-sm">
            <form onSubmit={handleSend} className="relative flex items-center gap-2 max-w-6xl mx-auto">
                <input
                    ...
                    className="w-full bg-gray-50 text-gray-900 placeholder-gray-400 border-0 rounded-xl py-3 pl-5 pr-14 focus:ring-2 focus:ring-green-100 focus:bg-white transition outline-none"
                    disabled={loading}
                />
                <button 
                    type="submit" 
